...
/* Structure representing one dependency of a file.
   ...
   stem_basename is the basename portion of the stem. Points within d->stem.
   If the stem contains both dirname and basename, then the distance from
   d->stem to d->stem_basename equals the length of d->stem_dirname. */
